...
const Tabs = (() => {
  ...
  // ── Rename guard — prevents renderStrip from destroying the active rename ──
  let renamingId = null;
  ...
  function renameTab(id) {
    ...
    function onKeydown(e) {
      ...
      if (e.key === 'Escape') { el.textContent = old; el.removeEventListener('keydown', onKeydown); el.blur(); }
    }
